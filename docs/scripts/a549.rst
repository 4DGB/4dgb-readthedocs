...
Restrction site marking and indexing
------------------------------------

Prior to analysis we need to index the reference genome we downloaded above and then search for MobI restrction cut sites. 
